      ...
      <div className="app__header">
        ...
        {user ? (
          <div className="app__logininContainer">
            <Button onClick={() => auth.signOut()} className="topbutton">
              Log Out
            </Button>
            <div
              style={{
          ...
          <div className="app__logininContainer">
            <Button onClick={() => setOpen(true)} className="topbutton">
              Sign Up
            </Button>
            <Button onClick={() => setOpenSignIn(true)} className="topbutton">
              Sign In
            </Button>
            <div
              style={{
